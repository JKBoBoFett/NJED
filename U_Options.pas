...
(d_type:dt_bool; RegName:'ForceThingLimit'; data:@ForceThingLimit; onExit:false),
(d_type:dt_int; RegName:'ThingLimit'; data:@ThingLimit; onExit:false)
);
...
procedure TOptions.Edit_UndoLevelExit(Sender: TObject);
begin
    UndoLimit:=strtoint(Edit_UndoLevel.text);
end;

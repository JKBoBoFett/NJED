...
uses
  ...
  StdCtrls, ExtCtrls, FieldEdit, J_Level,GlobalVars, U_Options;
...
type
  TLHEdit = class(TForm)
    ...
    EBPPU: TEdit;
    Label12: TLabel;
    EBThingGroupBox: TGroupBox;
    Label14: TLabel;
    EBThing: TEdit;
    EBCheckBox: TCheckBox;
    EBLabelThingCnt: TLabel;
    LabelNote1: TLabel;
...
begin
 EBLabelThingCnt.Caption:=inttostr(level.Things.Count);
 Result:=false;
With Level.Header do
begin
 EBCheckBox.Checked:= ForceThingLimit;
  vTL.SetAsInt(ThingLimit);
 ...
 ForceThingLimit:= EBCheckBox.Checked;
 ThingLimit:=vTL.AsInt;

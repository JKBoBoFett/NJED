...
type
  TItemEdit = class(TForm)
    ...
    procedure BNToolsClick(Sender: TObject);
  private
    citemtype:integer;
    fe:TFieldEdit;
    Cur_Sec:TJKSector;
...
begin
 ...
 fe.AddFieldFloat('AMBIENT',ID_AMBIENT,Ambient); //NJED 09/11/22
...
procedure TItemEdit.BNlightClick(Sender: TObject);
begin
VertexLight.Show;
VertexLight.LoadSurface;
end;
